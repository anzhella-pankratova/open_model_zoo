...
import models
import monitors
from pipelines import get_user_config, NewAsyncPipeline2
...
def main():
    ...
    pipeline = NewAsyncPipeline2(ie, model, plugin_config, args.device, args.num_infer_requests)
    ...
    while True:
        ...
        if pipeline.is_ready():
            ...
            pipeline.exec_net_detector.wait(num_requests=1)
